...
public class OJBMetadataGenerator {
    ...
    protected static void updateFields(final FenixDomainModel domainModel, final ClassDescriptor classDescriptor,
	...
	// write the metaObject for all domain objects
	addFieldDescriptor(domainModel, "oidMetaObject", "Long", fieldID++, classDescriptor, persistentFieldClass);
    ...
    protected static void addPrimaryFieldDescriptor(FenixDomainModel domainModel, String slotName, String slotType, int fieldID,
    ...
    protected static void addFieldDescriptor(FenixDomainModel domainModel, String slotName, String slotType, int fieldID,
	    ClassDescriptor classDescriptor, Class persistentFieldClass) throws Exception {
